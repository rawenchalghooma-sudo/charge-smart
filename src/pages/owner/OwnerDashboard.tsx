      ...
      <section className="flex flex-col gap-3 md:flex-row md:items-end md:justify-between">
        <div>
          ...
          <p className="mt-2 text-sm text-slate-500">
            Suivez vos bornes, vos réservations et votre énergie.
          </p>
        </div>
        ...
        <div className="flex flex-col gap-3 sm:flex-row sm:items-center">
          ...
          <button
            ...
            className="flex items-center justify-center gap-2 rounded-2xl border border-red-100 bg-red-50 px-4 py-3 text-sm font-bold text-red-600 transition hover:bg-red-100"
          >
            <LogOut size={16} />
            Déconnexion
          </button>
          ...
          <div className="rounded-3xl border border-slate-200 bg-white p-6 shadow-sm">
            ...
            <div className="mt-5 space-y-4">
              ...
              <QuickAction
                ...
                desc="Suivre la production solaire et la batterie."
                to="/owner/energy"
              />
            </div>
          </div>
